...
export const SECTIONED_EXPORT_MODE_VALUES = ["human", "compact_brief"] as const;
export type SectionedExportMode = (typeof SECTIONED_EXPORT_MODE_VALUES)[number];
...
export function modeUsesSelectableSections(mode: ExportMode): mode is SectionedExportMode {
  return mode !== "codex_ready";
}
